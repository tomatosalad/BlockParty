...
#pragma config(Servo,  srvo_S1_C3_2,    servoBeta,            tServoNone)
#pragma config(Servo,  srvo_S1_C3_3,    servoGamma,           tServoNone)
#pragma config(Servo,  srvo_S1_C3_4,    servoDelta,           tServoNone)
#pragma config(Servo,  srvo_S1_C3_5,    servoEpsilon,         tServoNone)
#pragma config(Servo,  srvo_S1_C3_6,    servoZeta,            tServoNone)
...
task main()
{
  initializeRobot();
				...
				nMotorEncoder[motorBeta] = 0;
 				while(nMotorEncoder[motorBeta] < 3571)
 					{
...
wait1Msec(1);
				...
				nMotorEncoder[motorBeta] = 0;
				while(nMotorEncoder[motorBeta] < 1234)
				  {
				  	motor[motorAlpha] = -50;
				  	motor[motorBeta] = 50;
				  }
